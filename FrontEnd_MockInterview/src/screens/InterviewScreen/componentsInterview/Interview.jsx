...
const Interview = () => {
  ...
  return (
    <>
      <div className="my-8 p-10 md:px-8 border shadow-lg rounded-lg bg-gradient-to-r from-blue-50 to-blue-100">
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-6">
          Let's Start the Interview
        </h1>
        <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8">
          {/* Interviewer Details Section */}
          <div className="w-full flex flex-col max-w-xl bg-white p-6 rounded-lg shadow-lg mb-8 border border-gray-200">
            ...
            <div className="flex flex-col gap-5 items-start">
              ...
              <div className="flex flex-col items-center bg-yellow-100 border border-yellow-300 rounded-lg p-4 shadow-md">
                ...
                <p className="text-center text-gray-800 text-sm leading-relaxed">
                  ...
                  for success. Let’s begin your journey!
                </p>
              </div>
              <button
                className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 transition duration-300"
                onClick={() => {
